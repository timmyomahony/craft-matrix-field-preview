...
/**
 * Matrix Field Preview config.php
 *
 * This file exists only as a template for the Matrix Field Preview settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'matrix-field-preview.php'
