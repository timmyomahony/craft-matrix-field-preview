        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $urls = [
                    ...
                    'matrix-field-preview/settings/matrix-fields/<fieldId:\d+>' => 'matrix-field-preview/matrix-fields/edit',
                ...
                if (Craft::$app->plugins->isPluginEnabled("neo")) {
                    $urls = array_merge($urls, [
                        ...
                        'matrix-field-preview/settings/neo-fields/<fieldId:\d+>' => 'matrix-field-preview/neo-fields/edit',
